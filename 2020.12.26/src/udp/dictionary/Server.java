...
public class Server {
    ...
    public static void main(String[] args) {
        ...
        try(DatagramSocket serverSocket = new DatagramSocket(PORT)) {
            System.out.printf("%s: DEBUG: 服务端 socket 已创建，UDP 端口：%d%n",new Date(),PORT);
    ...
    static {
        {
            ...
            translation.chinese = "n. 苹果，苹果树，苹果似的东西；[美俚]炸弹，手榴弹，（棒球的）球；[美俚]人，家伙。";
        ...
        {
            Translation translation = new Translation();
            translation.chinese = "n. [园艺] 梨树；梨子";
    ...
    private static String service(String host, int port, String request) {
        ...
        responseBuilder.append(translation.chinese);
